#
#  Be sure to run `pod spec lint CustomAlert.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "CustomAlert"
  spec.version      = "0.0.1"
  spec.summary      = "🔔 Custom Alert for SwiftUI (forked with Cocoapods support)"
...
If the content is too large because the text is too long or the text doesn't fit because of accessibility scaling the content will scroll just like in a SwiftUI Alert.
  ...
  spec.homepage     = "https://github.com/aswathr/CustomAlert"
  ...
  spec.source       = { :git => "https://github.com/aswathr/CustomAlert", :tag => "#{spec.version}" }
  ...
  spec.dependency "WindowKit", "~> 0.0.1"
